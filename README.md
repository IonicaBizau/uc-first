...
### `ucFirst(input)`
Uppercase the first character in the input string.

#### Params

- **String** `input`: the string we want to manipulate.

#### Return
- **String** The input string is returned, with its first character in uppercase.
